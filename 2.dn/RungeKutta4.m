...
%funkcija izraèuna rešitev enaèbe y'=fun(x,y) z runge-kutta metodo reda 4
...
Y = zeros(st_iteracij+1,vels); %vrstica, ki vsebuje y_i oz. èe imamo sistem, je to matrika, ki 
