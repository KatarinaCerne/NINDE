...
%funkcija izraèuna rešitev enaèbe y'=fun(x,y) z Milneovo prediktor-korektor
%metodo
...
%y0 ... zaèetni približek, v tem primeru vektor (vrstica), ki vsebuje y(a) in y'(a)
%h ... korak iteracije

%Izhod:
%res ... matrika, ki v 1. stolpcu vsebuje približke za y(x_i) pri delilnih toèkah
%x_i, v drugem stolpcu pa približke za y'(x_i)
